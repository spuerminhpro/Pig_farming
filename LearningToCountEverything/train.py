...
data_split_file = data_path + 'data_split.json'
im_dir = data_path + 'images'
gt_dir = data_path + 'gt_density_maps'
model_path = r'C:\Users\phann\Documents\Pig_farming\LearningToCountEverything\data\pretrainedModels\FamNet_Save1.pth'
